...
<form method="post" action="indexconnect.php">
<div id="app">
  <div class='item-base'>
  ...
  <div class="block">
     <div class="company">
      <div class="title">
        ...
        <div class="main">Bienvenue</div>
      </div>
    </div>
    <div class="container">
      <div class="top">
        <div class="mess">Pour continuer, veuillez confirmer votre identité </div>
        <div :class="inputClassHandler">
          <input id="passwordInput" type="password" name="password" v-model="account" @blur="reset" @focus="toggle" maxlength="39">
          <span class="span">Saisissez votre mot de passe</span>
        </div>
        <div class="body-checkbox">
          <input id="c1" type="checkbox" onclick="show()">
          <label for="c1">Afficher le mot de passe</label>
        </div>
      </div>
      <div class="bottom">
        <div class="height"></div>
        <div class="operator">
          <button class="create" onclick="redirectToPage()">Mot de passe oublié ?</button>
